...
每小时有0.3 一天5轮 一天1.5
脚本没写过盾的 如果提示click啥的就是需要手动阅读一次并关闭页面(注意 千万不要返回)
没用ios设备所以不清楚能不能抓到ck
拉一人头提现0.3奖励0.5
[task_local]
#10s阅读
0 8-14/1 * * * https://raw.githubusercontent.com/Wenmoux/scripts/master/jd/jd_limitBox.js, tag=618限时盲盒, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
[rewrite_local]
#10s阅读
