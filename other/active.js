...
async function un3(id){
 ...
 await get(s,"signPost&comm_id=25&id=418")
...
async function un4(ids){
  ...
  await get(s,`share&comm_id=${ids}&share_type=task&task_id=311`)
  await get(s,`taskGamePlayTime&comm_id=${ids}&gameid=106235`)
  let res = await get("universal","getAllTasklist&comm_id=25");
...
async function other() {
  ...
  //  await lottery("lottery", 77, [1,2,3,4,5],"\n[9992023]") 
