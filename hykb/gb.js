...
async function dh(){
  ...
  //  await get("zhuli","mycode&comm_id=41")
   //await get("yuyue2020/m","mycode&comm_id=17&isyuyue=0&testkey=4399NoneDeviceId")
      await get("lottery/m","duihuanprize&dhid=13&comm_id=52&resure=1&isyuyue=0")
...
async function q(){
  await lottery("lottery", 49, [1, 2, 3,4],"\n[20224114]")
    await lottery("lottery", 48, [1, 2, 3,4,5],"\n[20224122]")
    await lottery("lottery", 47, [1, 2, 3,4,5],"\n[222041]")
 }
...
async function xpj(){
  ...
  await get(s, "shiwan&gid=102781")
  
  await get(s, "addjifen&id=16&isdown=1")
...
//xpj()
//get("universal","getLuckyPrize&comm_id=6")
//yyh()
//lottery("lottery", 62, [1, 2, 3, 4,5],"\n[220713]") 

/*get("2022shujia/m", "guangczzl")
get("2022shujia/m","guang&resure=1")
get("2022shujia/m","guang&resure=1&i=3")*/
//lottery("lottery", 55, [1, 2, 3, 4,5, 6,7],"\n[220713]") 
//get("2022xinpinjie", "addjifen&id=6&isdown=1")
//lottery("lotterysj", 1,[15,11,10,13,3,4,6], "\n[220824]")
//get("lotterysj/m", "duihuanprize&dhid=2&resure=1&comm_id=1&isyuyue=0")
async function un1(){
 prize= "\n金秋: "
 s= "universal"
 result =""
...
async function un2(){
 ...
 await get(s,"signPost&comm_id=9&id=73")
...
async function un3(){
 ...
 console.log(str)
 for (id of str) {
  console.log("lingqushiwan&gameid=" + id.split('"')[1])
     //await get(s, "lingqushiwan&gameid=" + id.split("n")[2])
}
}
async function ce(){
 s= "celebrate"
 await get(s,"login")
 //await get(s,"completeTask&id=1004")
 await get(s,"getTasklist")
 await get(s,"getRewardList")
 await get(s,"getReplyList")
 /*
 await get(s,"share")
 await get(s,"share")
